...
## n8n
1. Створив таблицю в **[Google Sheets](https://docs.google.com/spreadsheets/d/1i-aKFasMZPMSjt-k60bQHdmrOx63aIyYdLQCNWGC9zk/edit?usp=sharing)** для заявок.
2. Зайшов у робоче середовище [n8n](https://dvar1ch.app.n8n.cloud/workflow/M9ALX6LslduDF1ew).
3. Додав **Google Sheets Trigger** → перевірку умови:
   - якщо в полі **Status** = `"Новий"`, тоді:
      - відправляти повідомлення замовнику на **email** через **Gmail**,
      - і надсилати повідомлення про нового замовника в [Telegram-бот](https://t.me/n8n_test_gravity_bot).
4. Нажав кнопку **"Execute Workflows"**, а також кнопку для активації, щоб воно автоматизовано працювало.
   
| Workflows                                                                                                                                |
| :--------------------------------------------------------------------------------------------------------------------------------------: |
|   <img width="1920" height="884" alt="image" src="https://github.com/user-attachments/assets/3ff4ff55-36bf-48ea-be8c-6e32f2cc441f" />    |
